...
int[] datos = {1, 2, 3, 5, 7, 9};
int objetivo = 7;
int idxLineal = Busquedas.busquedaLineal(datos, objetivo);
System.out.println("Búsqueda lineal: índice = " + idxLineal);
int idxBinaria =
Busquedas.busquedaBinariaEficiente(Arrays.copyOf(datos, datos.length),
objetivo);
System.out.println("Búsqueda binaria eficiente: índice = " +
idxBinaria);
int n = 10;
System.out.println("Fibonacci exponencial (" + n + "): " +
Fibonacci.fibExponencial(n));
System.out.println("Fibonacci memoization (" + n + "): " +
Fibonacci.fibMemoization(n));
System.out.println("Fibonacci iterativo (" + n + "): " +
Fibonacci.fibIterativo(n));
int idxAnalisis = AnalisisCasos.busquedaConAnalisis(datos, objetivo);
System.out.println("Análisis de casos: índice = " + idxAnalisis);
